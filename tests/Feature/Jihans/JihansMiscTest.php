...
class JihansMiscTest extends TestCase
{
    ...
    public function test_returns_store_debits_jihans_stock(): void
    {
        ...
        JihansRetailStock::create(['product_id' => $product->id, 'quantity' => 20, 'unit_id' => $unit->id]);
        ...
        $this->assertEquals(15.0, (float) JihansRetailStock::where('product_id', $product->id)->value('quantity'));
    }
    ...
    public function test_returns_store_rejects_quantity_above_stock(): void
    {
        ...
        JihansRetailStock::create(['product_id' => $product->id, 'quantity' => 3, 'unit_id' => $unit->id]);
        ...
        $this->assertEquals(3.0, (float) JihansRetailStock::where('product_id', $product->id)->value('quantity'));
    }
}
