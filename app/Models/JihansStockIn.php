...
class JihansStockIn extends Model
{
    protected $table    = 'jihans_stock_in';
    ...
    public function details(): HasMany    { return $this->hasMany(JihansStockInDetail::class, 'stock_in_id'); }
}
