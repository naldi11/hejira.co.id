                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center font-black text-{{ $accentColor }}-600 border border-slate-200 shadow-inner group-hover:bg-{{ $accentColor }}-600 group-hover:text-white transition-all">
