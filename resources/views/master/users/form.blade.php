            ...
            <div class="bg-white rounded-[2rem] shadow-sm border border-slate-200 p-8 space-y-8">
                <div class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <select name="entity" required class="w-full px-5 py-3.5 bg-slate-50 border-2 border-slate-100 rounded-2xl text-sm font-bold text-slate-700 focus:bg-white focus:border-indigo-500 transition-all outline-none">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="branch_id" class="w-full px-5 py-3.5 bg-slate-50 border-2 border-slate-100 rounded-2xl text-sm font-bold text-slate-700 focus:bg-white focus:border-indigo-500 transition-all outline-none">
