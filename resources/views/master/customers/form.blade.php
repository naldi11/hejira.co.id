                ...
                <div class="p-10 space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <select name="type" class="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-5 py-3.5 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none font-bold text-slate-900 appearance-none cursor-pointer">
                        ...
                        <div>
                            ...
                            <select name="is_active" class="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl px-5 py-3.5 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none font-bold text-slate-900 appearance-none cursor-pointer">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" rows="3" placeholder="Masukkan alamat lengkap customer..."
                                class="bg-slate-50 border-2 border-slate-100 rounded-3xl px-6 py-4 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none w-full font-medium text-slate-700">{{ old('address', $customer->address ?? '') }}</textarea>
                        </div>
