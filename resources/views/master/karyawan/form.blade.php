                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2 pt-4 border-t border-slate-100">
                        ...
                        <textarea name="address" rows="3" placeholder="Jl. Raya No. 123..."
                                  class="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-2xl text-sm font-medium text-slate-800 placeholder:text-slate-400 focus:bg-white focus:border-indigo-500 transition-all outline-none resize-none">{{ old('address', $karyawan->address ?? '') }}</textarea>
                    </div>
                </div>
            </div>
