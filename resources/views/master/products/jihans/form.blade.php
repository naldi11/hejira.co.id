...
@push('styles')
    <style>
        ...
        .ts-dropdown .active { background-color: #ffedd5 !important; color: #ea580c !important; }
    </style>
@endpush
    ...
    <div class="max-w-5xl mx-auto">
        <form method="POST"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name', $product->name ?? '') }}" required
                                ...
                                class="bg-slate-50 border-2 border-slate-100 rounded-2xl px-5 py-3.5 focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all outline-none w-full font-bold text-slate-900">
                        ...
                        <div>
                            ...
                            <input type="text" name="barcode" value="{{ old('barcode', $product->barcode ?? '') }}"
                                ...
                                class="bg-slate-50 border-2 border-slate-100 rounded-2xl px-5 py-3.5 focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all outline-none w-full font-mono text-sm">
                        </div>
                        ...
                        <div x-data="{
                            ...
                            <div class="relative group">
                                ...
                                <div @click="document.getElementById('imageInput').click()" 
                                     class="w-full bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-4 flex items-center gap-4 cursor-pointer hover:bg-slate-100 hover:border-orange-300 transition-all">
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-10">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            <label class="text-xs font-black text-orange-500 uppercase tracking-widest ml-1 mb-2 block">Harga Jual (Rp) <span class="text-rose-500">*</span></label>
                            <input type="number" name="selling_price" value="{{ old('selling_price', $product->selling_price ?? 0) }}" min="0" step="0.01" required
                                class="bg-orange-50 border-2 border-orange-100 rounded-2xl px-5 py-3.5 focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all outline-none w-full font-black text-orange-600">
                        </div>
                        <div>
                                    ...
                                    <div class="flex-1 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="number" name="tiered_prices[{{ $i }}][min_qty]" value="{{ $tier['min_qty'] }}" min="1" placeholder="cth: 50"
                                                class="w-full pl-24 pr-4 py-3 bg-white border-2 border-slate-100 rounded-xl focus:border-orange-500 outline-none transition-all font-bold text-slate-900 text-sm">
                                        </div>
                                    </div>
                                    <div class="flex-1 w-full">
                                        <div class="relative">
                                            ...
                                            <input type="number" name="tiered_prices[{{ $i }}][price]" value="{{ $tier['price'] }}" min="0" placeholder="cth: 142000"
                                                class="w-full pl-24 pr-4 py-3 bg-white border-2 border-slate-100 rounded-xl focus:border-orange-500 outline-none transition-all font-bold text-orange-600 text-sm">
                                        </div>
                                    </div>
                ...
                <div class="p-10 space-y-10">
                        ...
                        <div class="flex flex-wrap gap-6">
                            @foreach([
                                ...
                                <label x-data="{ on: {{ $checked ? 'true' : 'false' }} }"
                                    :class="on ? 'border-orange-600 bg-orange-50 text-orange-600' : 'border-slate-100 bg-slate-50 text-slate-400 hover:border-slate-200'"
                                    ...
                                    <div class="mt-4 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all" :class="on ? 'bg-orange-600 border-orange-600' : 'border-slate-200'">
                    ...
                    <div class="border-t border-slate-100 pt-10">
                        ...
                        <textarea name="notes" placeholder="Tambahkan catatan khusus untuk produk ini..." rows="3"
                            class="bg-slate-50 border-2 border-slate-100 rounded-3xl px-6 py-5 focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all outline-none w-full font-medium text-slate-700">{{ old('notes', $product->notes ?? '') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4 pt-4 pb-12">
                <button type="submit"
                    class="flex-1 px-8 py-4 bg-orange-600 text-white rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] hover:bg-orange-700 transition-all shadow-xl shadow-orange-600/20 flex items-center justify-center gap-3">
