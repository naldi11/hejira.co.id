...
@endphp
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 rounded-2xl overflow-hidden bg-slate-100 flex-shrink-0 flex items-center justify-center border border-slate-200 group-hover:border-{{ $accentColor }}-200 transition-colors">
                                        @if($product->image)
                            ...
                            <td class="px-6 py-4 text-right">
                                <span class="text-sm font-black text-indigo-600">Rp{{ number_format($product->selling_price, 0, ',', '.') }}</span>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    <button type="button"
                                        ...
                                        class="w-9 h-9 flex items-center justify-center rounded-xl bg-slate-50 text-slate-400 hover:bg-indigo-50 hover:text-indigo-600 transition-all border border-slate-200">
    ...
    <div x-data="{
        ...
        <div x-show="open"
            ...
            <div class="p-8 bg-slate-900 text-white shrink-0">
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-3 mb-2">
                            <span class="px-3 py-1 bg-indigo-500 text-[10px] font-black uppercase tracking-widest rounded-lg" x-text="product.code"></span>
                        ...
                        <p class="text-slate-400 text-xs font-bold uppercase tracking-[0.2em] mt-1" x-text="product.category"></p>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between p-3 bg-indigo-50 rounded-2xl border border-indigo-100 text-indigo-600">
                                ...
                                <tbody class="divide-y divide-slate-200">
                                    <template x-for="tier in product.tiers" :key="tier.min_qty">
                                        <tr>
                                            ...
                                            <td class="px-5 py-3 text-right text-sm font-black text-indigo-600" x-text="'Rp' + fmt(tier.price)"></td>
                                        </tr>
                                    </template>
                                </tbody>
                            </table>
            ...
            <div class="p-8">
                ...
                <form action="{{ route(($routePrefix ?? 'master.') . 'products.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="submit" 
                            class="flex-1 px-6 py-4 bg-indigo-600 text-white rounded-2xl font-bold text-xs uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-600/20">Import Data</button>
                    </div>
                </form>
            </div>
        </div>
