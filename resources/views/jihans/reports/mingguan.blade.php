...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
        <form action="{{ route('jihans.reports.mingguan') }}" method="GET" class="flex flex-wrap items-end gap-4">
            <div class="space-y-1">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('jihans.reports.pdf', ['type' => 'mingguan'] + request()->all()) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-xl font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all duration-200 shadow-sm">
                    <span class="material-symbols-outlined text-sm mr-1">picture_as_pdf</span>
                    Cetak PDF
                </a>
                <a href="{{ route('jihans.reports.mingguan') }}" class="inline-flex items-center px-4 py-2 bg-gray-100 border border-transparent rounded-xl font-semibold text-xs text-gray-600 uppercase tracking-widest hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-300 transition-all duration-200">
                    Reset
                </a>
            </div>
        </form>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-orange-50 border-b border-orange-100">
                        <th class="px-6 py-4 text-xs font-bold text-orange-800 uppercase tracking-wider">Periode Minggu</th>
