...
<div class="max-w-5xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <a href="{{ route('jihans.returns-to-gudang.index') }}" class="text-[#f97316] hover:text-[#ea580c] font-medium text-sm flex items-center gap-1">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
        <div class="p-6 border-b border-gray-100 flex flex-wrap gap-6 items-center justify-between bg-[#fff7ed]">
            <div>
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 border-b border-gray-100">
            <div>
                <p class="text-xs text-gray-500 font-medium uppercase tracking-wider mb-1">Pengirim (Entity)</p>
                <p class="font-bold text-gray-800 text-lg">Jihan's Food</p>
                    ...
                    <tbody class="divide-y divide-gray-200 text-sm">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-3 px-4 border-r border-gray-200">
                                <span class="px-2 py-1 bg-orange-50 text-orange-700 rounded text-xs font-semibold uppercase">{{ $detail->condition }}</span>
                            </td>
