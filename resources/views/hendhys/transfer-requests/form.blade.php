...
<div class="max-w-4xl mx-auto" x-data="requestForm()">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('hendhys.transfer-requests.store') }}" method="POST">
            @csrf
            ...
            <div class="p-6 border-b border-gray-100 bg-[#faf7f5]">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="notes" value="{{ old('notes') }}" placeholder="Misal: Stok Tepung Menipis"
                               class="w-full border-gray-300 rounded-lg focus:ring-[#d97706] focus:border-[#d97706] bg-white">
            ...
            <div class="p-6">
                ...
                @if($errors->has('items.*'))
                    <div class="mt-4 p-3 bg-red-50 text-red-600 text-sm rounded-lg border border-red-200">
                        Pastikan semua baris item produk terisi dengan benar.
                    </div>
                @endif
            </div>

            <div class="p-6 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
                <a href="{{ route('hendhys.transfer-requests.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">Batal</a>
