    ...
    <div class="max-w-4xl mx-auto">
        <div class="mb-6 flex items-center justify-between print:hidden">
            <a href="{{ route('hendhys.productions.index') }}"
                class="text-[#d97706] hover:text-[#b45309] font-medium text-sm flex items-center gap-1">
            ...
            <button onclick="window.print()"
                class="bg-gray-800 text-white hover:bg-gray-900 px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2 shadow-sm">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div
            class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden print:shadow-none print:border-gray-800">
            {{-- Header Bukti Produksi --}}
            <div
                class="p-8 border-b border-gray-100 bg-amber-50/30 print:bg-transparent print:border-b-2 print:border-gray-800">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 tracking-tight">BUKTI PRODUKSI</h2>
                        <p class="text-sm text-gray-500 mt-1">Pusat Hendhy's Brownies</p>
                    </div>
                    <div class="flex gap-8">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-gray-800">
                                {{ \Carbon\Carbon::parse($production->date)->format('d F Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8">
                <div
                    class="flex flex-wrap gap-x-12 gap-y-6 mb-8 p-4 bg-gray-50 rounded-lg border border-gray-100 print:bg-transparent print:border-none print:p-0">
                    <div>
                ...
                <table class="w-full text-left border-collapse print:border print:border-gray-800">
                    <thead>
                        <tr
                            class="bg-gray-50 text-gray-500 text-xs uppercase tracking-wider border-y border-gray-200 print:border-gray-800 print:bg-gray-100">
                    ...
                    <tbody class="divide-y divide-gray-100 text-sm print:divide-gray-800">
                        @foreach($production->details as $index => $detail)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="py-3 px-4 text-right font-bold text-[#d97706]">
                                    {{ (float) $detail->quantity_produced }}</td>
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 text-sm text-gray-500 text-center print:border-gray-800">
                    <p>Dokumen ini adalah bukti sah pencatatan hasil produksi Hendhy's Pusat secara otomatis.</p>
