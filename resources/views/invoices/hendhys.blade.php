...
<body>
    <div class="header">
        <div class="company-info">
            <div class="logo">HENDHYS BROWNIES</div>
            <div>{{ $transaction->branch->name ?? 'Pusat' }}</div>
            <div>{{ $transaction->branch->address ?? 'Jl. Contoh No. 456, Indonesia' }}</div>
            <div>Telp: {{ $transaction->branch->phone ?? '0812-9876-5432' }}</div>
        </div>
