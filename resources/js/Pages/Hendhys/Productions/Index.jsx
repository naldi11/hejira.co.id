                                ...
                                {loading ? <SkeletonTableRows rows={6} columns={5} />
                                    ...
                                    : productions.data.map((p) => (
                                        <tr key={p.id} className="hover:bg-gray-50 dark:hover:bg-white/[0.01]">
                                            <td className="px-6 py-4 font-bold text-gray-800 dark:text-white/90">{p.production_number}</td>
                                            ...
                                            <td className="px-6 py-4 text-center"><Link href={route('hendhys.productions.show', p.id)} className="text-sm font-medium text-amber-600 hover:text-amber-800 dark:text-amber-400">Detail</Link></td>
                                        </tr>))}
                            </tbody>
                        </table>
                    </div>
