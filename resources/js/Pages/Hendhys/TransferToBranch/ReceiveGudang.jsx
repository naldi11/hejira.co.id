...
export default function ReceiveGudang({ transfer: t }) {
    const initialQty    = {};
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('hendhys.gudang-transfers.receive', t.id));
    };
    ...
    return (
        <HendhysLayout pageTitle="Konfirmasi Penerimaan Gudang">
            ...
            <form onSubmit={submit} className="mx-auto max-w-4xl space-y-5">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-550 dark:text-gray-400">
                        {t.transfer_number} — dari Gudang Utama ke {t.branch}
                    </p>
                </div>
                ...
                <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
                    <div className="border-b border-gray-100 bg-gray-50/50 px-6 py-4 dark:border-gray-800 dark:bg-white/[0.01]">
                        <h3 className="font-bold text-gray-855 dark:text-white/90">Rincian Barang Diterima</h3>
                        <p className="mt-0.5 text-xs text-gray-550 dark:text-gray-400">Sesuaikan qty jika ada selisih dengan yang dikirim</p>
                    </div>
                    <div className="overflow-x-auto">
                        <table className="w-full text-left text-sm">
                            <thead className="border-y border-gray-200 bg-gray-50 text-[10px] font-bold uppercase tracking-wider text-gray-550 dark:border-gray-800 dark:bg-white/[0.02] dark:text-gray-400">
                                <tr>
                                    <th className="px-6 py-3 font-semibold">Produk</th>
                                    <th className="px-6 py-3 text-center font-semibold">Qty Kirim</th>
                                    <th className="px-6 py-3 text-center font-semibold">Qty Diterima</th>
                                    <th className="px-6 py-3 text-center font-semibold">Kondisi</th>
                                </tr>
                            </thead>
                    ...
                    <div className="grid grid-cols-1 gap-5 p-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Nama kurir/pengirim dari Gudang Utama"
                                className={fieldClass}
                            />
                        </div>
                    </div>
                ...
                <div className="flex justify-end gap-3 text-sm">
                    <button
                        ...
                        className="inline-flex items-center gap-2 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-white/[0.03] px-5 py-2.5 text-sm font-bold text-gray-750 dark:text-gray-300 shadow-theme-xs hover:bg-gray-50 dark:hover:bg-white/[0.05] transition-colors"
                    >
