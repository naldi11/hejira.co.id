...
export default function SearchModal({ products, onAdd, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-start justify-center bg-black/50 pt-[10vh] backdrop-blur-sm"
            onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
            <div className="flex w-full max-w-2xl flex-col overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-gray-900"
                ...
                <div className="flex items-center gap-3 border-b border-gray-100 bg-gradient-to-r from-orange-600 to-orange-500 px-5 py-3.5 dark:border-gray-800">
                    ...
                    <span className="font-bold text-white">Cari Produk</span>
                    <button onClick={onClose}
                        className="ml-auto flex h-7 w-7 items-center justify-center rounded-full bg-white/20 text-white transition hover:bg-white/30">
                ...
                <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-800">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full rounded-xl border border-gray-200 bg-gray-50 py-2.5 pl-10 pr-4 text-sm outline-none transition focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-400/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                        />
                        {query && (
                    ...
                    <p className="mt-1.5 text-[10px] text-gray-400">
                        ...
                        {filtered.length > 0 && <span className="ml-2">· Gunakan <kbd className="rounded border border-gray-200 bg-gray-100 px-1 py-0.5 font-mono text-[9px]">↑↓</kbd> navigasi, <kbd className="rounded border border-gray-200 bg-gray-100 px-1 py-0.5 font-mono text-[9px]">Enter</kbd> pilih</span>}
                    </p>
                </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            <td className="px-4 py-2.5">
                                                <span className="rounded bg-gray-100 px-1.5 py-0.5 font-mono text-[10px] text-gray-500 dark:bg-gray-700 dark:text-gray-400">
                                                    {p.code}
                                                </span>
                                            </td>
                                            <td className="px-4 py-2.5 font-semibold text-gray-800 dark:text-white">
                                                {p.name}
                                                {isActive && !isEmpty && (
                                                    <span className="ml-2 inline-flex items-center gap-0.5 rounded bg-orange-100 px-1.5 py-0.5 text-[9px] font-bold text-orange-600 dark:bg-orange-900/30 dark:text-orange-400">
                                                        <Icon name="keyboard_return" className="text-[11px]" /> Enter
                                                    </span>
                                                )}
                                            </td>
                                            <td className="px-4 py-2.5 text-center">
                                                <span className={`inline-block min-w-[32px] rounded-lg px-2 py-0.5 text-center text-xs font-bold ${
                                                    isEmpty
                                            ...
                                            <td className="px-4 py-2.5 text-center text-xs font-semibold text-gray-500 dark:text-gray-400">
                                                {p.unit}
                                            </td>
                                            <td className="px-4 py-2.5 text-right font-bold text-gray-800 tabular-nums dark:text-white">
                ...
                <div className="flex items-center justify-between border-t border-gray-100 bg-gray-50/80 px-5 py-3 dark:border-gray-800 dark:bg-white/[0.02]">
                    <div className="flex items-center gap-2 text-xs text-gray-400">
                        ...
                        <span>Klik baris atau tekan Enter untuk menambah</span>
                    </div>
                    <button onClick={onClose}
                        ...
                        Tutup
                        <kbd className="rounded bg-gray-100 px-1 py-0.5 font-mono text-[9px] text-gray-400 dark:bg-gray-700">Esc</kbd>
                    </button>
                </div>
            </div>
        </div>
