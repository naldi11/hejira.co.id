                            ...
                            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                <div className="space-y-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="font-bold text-gray-800 dark:text-orange-100">Laci Kasir Sedang Tertutup</h3>
                                    </div>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <div>
                                    <button 
                                        ...
                                        className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold rounded-xl shadow-sm transition"
                                    >
