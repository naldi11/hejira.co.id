...
export default function ReportLaci({ rows, filters, activeShift, auth }) {
    ...
    const [exportType, setExportType] = useState('shift');
    ...
    const handleExport = () => {
        let url = '';
        const base = route('jihans.reports.pdf', exportType === 'shift' ? 'laci' : exportType);
        if (exportType === 'shift') {
                                        ...
                                        return (
                                            <tr key={i} className="hover:bg-gray-50 dark:hover:bg-white/[0.01]">
                                                ...
                                                <td className="px-4 py-4 text-center font-medium text-rose-500">
                                                    {formatRupiah(r.total_expenses ?? 0)}
                                                </td>
                                                ...
                                                <td className="px-4 py-3 text-center">
                                                    <button 
                                                        ...
                                                        className="inline-flex items-center gap-1 text-xs text-orange-600 hover:text-orange-700 dark:text-orange-400 dark:hover:text-orange-300 font-semibold whitespace-nowrap"
                                                    >
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <button
                                    ...
                                    className="text-xs font-semibold text-orange-600 hover:text-orange-700 bg-orange-50 px-2 py-1 rounded-md transition"
                                >
                                    + Tambah Pengeluaran
                                </button>
                            </div>
                                        ...
                                        <div key={index} className="flex gap-2 items-start">
                                            <div className="flex-1 space-y-2">
                                                <input
                                                    ...
                                                    className="w-full px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-800 dark:text-white focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                                                />
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full pl-9 pr-3 py-1.5 text-sm border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-800 dark:text-white focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
                                                    />
                                                </div>
                                            </div>
                                            <button
            ...
            <Modal show={exportModal} onClose={() => setExportModal(false)} maxWidth="md">
                <div className="p-6">
                    <h3 className="text-lg font-bold text-gray-800 dark:text-white/90 flex items-center gap-2 mb-5">
                        <Icon name="picture_as_pdf" className="text-orange-500" /> Export Laporan PDF
                    </h3>
                    ...
                    {exportType === 'bulanan' && (
                        <div className="mb-5">
                            ...
                            <input type="month" value={exportMonth} onChange={e => setExportMonth(e.target.value)}
                                className="w-full rounded-lg border-gray-200 py-2.5 px-3 text-sm dark:border-gray-700 bg-white dark:bg-gray-800 dark:text-white focus:border-orange-500 focus:ring-orange-500 cursor-pointer" />
                        </div>
                    )}
                    ...
                    <div className="flex gap-2 justify-end">
                        ...
                        <button type="button" onClick={handleExport}
                            className="flex items-center gap-1.5 px-5 py-2 bg-orange-500 hover:bg-orange-600 text-white text-sm font-bold rounded-lg shadow-sm transition">
