...
export default function TransferFromHendhysIndex({ transfers, filters }) {
    ...
    const reload = (e) => {
        ...
        router.get(route('jihans.transfer-from-hendhys.index'), p, {
            preserveState: true,
            preserveScroll: true,
            replace: true,
                                ...
                                {loading ? (
                                    ...
                                    transfers.data.map((t) => (
                                        <tr key={t.id} className="hover:bg-gray-50 dark:hover:bg-white/[0.01]">
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <Link href={route('jihans.transfer-from-hendhys.show', t.id)} className="text-sm font-medium text-amber-600 hover:text-amber-800 dark:text-amber-400">
                                                    Detail
                                                </Link>
                                            </td>
                                        </tr>
